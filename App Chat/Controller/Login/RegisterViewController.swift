...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let gesture = UITapGestureRecognizer(target: self, action: #selector(didTapChangePrfilePic))
//        gesture.numberOfTouchesRequired = 1
//        gesture.numberOfTapsRequired = 1
        imageView.addGestureRecognizer(gesture)
    }
    @objc private func didTapChangePrfilePic() {
    ...
    func alertUserLoginError(message: String = "Vui lòng nhập thông tin tạo tài khoản hợp lệ") {
        let alert = UIAlertController(title: "Không ổn", message: message, preferredStyle: .alert)
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Ảnh hồ sơ", message: "Hãy chọn bức ảnh bạn thích", preferredStyle: .actionSheet)
